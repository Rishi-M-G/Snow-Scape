...
public class TestingClientMultiThread
{
     ...
     static int RequestPerThread = 1000;
    ...
    public static void main(String[] args) throws Exception 
    {
        ...
        System.out.println("###############################################################################");
        System.out.println("Total milli seconds taken by all http post requests calculated individually : "+total );
        ...
        throughPut=(double)(totalReq)/((double)total/1000F);
